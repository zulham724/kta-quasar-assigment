<template>
<div>
    <q-item clickable @click="goToResult(item.data.assigment.id)" :disable="loading">
        ...
        <q-item-section top>
            <q-item-label>
                <b>Selamat, </b>
               paket soal '<b>{{item.data.assigment.name}}</b>' Anda dapat dijadikan berbayar!
            </q-item-label>
