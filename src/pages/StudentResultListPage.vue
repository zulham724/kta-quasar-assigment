...
<div>
    ...
    <q-pull-to-refresh @refresh="init">
        ...
        <q-infinite-scroll @load="onLoad" :offset="250" v-if="StudentResult.items.data">
            <q-intersection style="min-height:25vh;min-width:100vw" class="q-pa-xs" v-for="(assigment, id) in StudentResult.items.data" :key="id">
                <student-result-item-component :assigment="assigment"></student-result-item-component>
            </q-intersection>
