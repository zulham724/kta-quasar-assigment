    ...
    <q-pull-to-refresh @refresh="init">
      <q-header elevated class="bg-white">
        <q-toolbar class="text-primary">
          ...
          <q-toolbar-title> Beranda </q-toolbar-title>
        ...
        <q-slide-transition>
          <div id="header" v-show="isShow">
            ...
            <div id="text-header" class="q-pa-md">
              <div class="row">
                <div class="col-12 text-blue text-h6">AGPAII DIGITAL</div>
              </div>
              <div class="row">
                <div class="col-12 text-primary text-h5">Penilaian</div>
              </div>
            </div>
            <div class="row">
        ...
        >
          <q-btn
            round
            color="primary"
            :icon="isShow ? 'keyboard_arrow_up' : 'keyboard_arrow_down'"
            size="sm"
            @click="isShow = !isShow"
          />
        </div>
        ...
        <q-infinite-scroll v-if="tab == 'publish'" @load="onLoadPublish" :offset="250">
          <div class="q-pa-none row items-start q-gutter-y-sm" v-if="Publish.items.data">
            <q-intersection
              ...
              :key="`publish-${assigment.id}`"
              style="min-height: 200px; width: 100vw"
            >
...
export default {
  components: {
    PublishItemComponent: () => import("components/assigment/publish/ItemComponent.vue"),
