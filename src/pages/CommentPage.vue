...
<div>
    <q-layout view="lHh Lpr lFf">
        ...
        <q-page-container v-if="assigment != null">
            ...
            <q-carousel v-model="slide" transition-prev="slide-right" transition-next="slide-left" animated infinite autoplay control-color="primary" class="rounded-borders" height="20vh" style="width:100%">
