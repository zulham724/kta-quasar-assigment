...
<div>
    <q-header elevated>
        <q-toolbar class="bg-blue">
            <q-toolbar-title>
                <div @click="$router.push({ name: 'build', params: { _step: 2 } })" class="text-right text-body1">Lanjut</div>
            </q-toolbar-title>
            <!--<q-icon name="keyboard_backspace" style="font-size: 1.5em;" clickable @click="$router.push({ name: 'build', params: { _step: 2 } })" />-->
            <q-btn flat round dense icon="arrow_right_alt" @click="$router.push({ name: 'build', params: { _step: 2 } })" />
        </q-toolbar>
    </q-header>
