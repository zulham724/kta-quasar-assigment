      ...
      <q-page-container v-if="assigment != null">
        ...
        >
          ...
          >
            <q-badge
              outline
              :color="`${question_list.answer == (question_list.answer_lists.find(item=>item.value) ? question_list.answer_lists.find(item=>item.value).id : false) ? 'green' : 'red'}`"
            >Jawaban anda {{question_list.answer == (question_list.answer_lists.find(item=>item.value) ? question_list.answer_lists.find(item=>item.value).id : false) ? 'benar' : 'salah'}}</q-badge>
            <q-input
              disable
              class="q-pa-sm"
              rounded
          ...
          <div v-if="question_list.pivot.assigment_type.description == 'textfield'" class="q-pt-md">
          ...
          <div v-if="question_list.pivot.assigment_type.description == 'textarea'" class="q-pt-md">
            <div class="text-caption">Jawaban anda</div>
            <q-input
              disable
              class="q-pa-sm"
